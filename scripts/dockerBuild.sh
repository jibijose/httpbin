...
#docker build --build-arg MVN_VERSION=3.9.3 -t jibijose/httpbin:jre17-latest -f docker/jre17/Dockerfile .
#docker build --build-arg MVN_VERSION=3.9.3 -t jibijose/httpbin:jdk17-latest -f docker/jdk17/Dockerfile .