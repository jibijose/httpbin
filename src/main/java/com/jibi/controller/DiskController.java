...
public class DiskController {
    ...
    @Operation(summary = "Disk write api", description = "Disk write api", tags = {"disk"})
    @ApiResponses(value = {
    ...
    @Parameter(name = "unit", description = "Unit of write bytes", schema = @Schema(description = "Unit", type = "string", allowableValues = {"MB", "GB"}))
    @Parameter(name = "count", description = "Count of write bytes", schema = @Schema(description = "Count", type = "integer"))
    @RequestMapping(
    ...
    @Operation(summary = "Disk read api", description = "Disk read api", tags = {"disk"})
    @ApiResponses(
            value = {
                    @ApiResponse(responseCode = "200", description = "Successful operation", content = @Content(array = @ArraySchema(schema = @Schema(implementation = Void.class)))),
                    @ApiResponse(responseCode = "500", description = "Internal server error")
            })
    @Parameter(name = "unit", description = "Unit of read bytes", schema = @Schema(description = "Unit", type = "string", allowableValues = {"MB", "GB"}))
    @Parameter(name = "count", description = "Count of read bytes", schema = @Schema(description = "Count", type = "integer"))
