...
public class FileController {
    ...
    public @ResponseBody
    byte[] imageFileType(@PathVariable String fileType) throws IOException {
    ...
    public @ResponseBody
    byte[] videoFileType(@PathVariable String fileType) throws IOException {
    ...
    public @ResponseBody
    byte[] audioFileType(@PathVariable String fileType) throws IOException {
    ...
    public @ResponseBody
    byte[] documentFileType(@PathVariable String fileType) throws IOException {
    ...
    public @ResponseBody
    byte[] otherFileType(@PathVariable String fileType) throws IOException {
    ...
    public @ResponseBody
    byte[] imageJpgSize(@PathVariable String size) throws IOException {
    ...
    public @ResponseBody
    byte[] imageGifSize(@PathVariable String size) throws IOException {
    ...
    public @ResponseBody
    byte[] imagePngSize(@PathVariable String size) throws IOException {
    ...
    @RequestMapping(
            ...
            produces = {"image/tiff"})
    public @ResponseBody
    byte[] imageTiffSize(@PathVariable String size) throws IOException {
    ...
    public @ResponseBody
    byte[] imageIcoSize(@PathVariable String size) throws IOException {
    ...
    @RequestMapping(
            ...
            produces = {"video/avi"})
    public @ResponseBody
    byte[] videoAviSize(@PathVariable String size) throws IOException {
    ...
    @RequestMapping(
            ...
            produces = {"video/mov"})
    public @ResponseBody
    byte[] videoMovSize(@PathVariable String size) throws IOException {
    ...
    @RequestMapping(
            ...
            produces = {"video/mp4"})
    public @ResponseBody
    byte[] videoMp4Size(@PathVariable String size) throws IOException {
    ...
    @RequestMapping(
            ...
            produces = {"video/ogg"})
    public @ResponseBody
    byte[] videoOggSize(@PathVariable String size) throws IOException {
    ...
    @RequestMapping(
            ...
            produces = {"video/wmv"})
    public @ResponseBody
    byte[] videoWmvSize(@PathVariable String size) throws IOException {
    ...
    public @ResponseBody
    byte[] audioMp3Size(@PathVariable String size) throws IOException {
    ...
    @RequestMapping(
            ...
            produces = {"audio/wav"})
    public @ResponseBody
    byte[] audioWavSize(@PathVariable String size) throws IOException {
    ...
    @RequestMapping(
            ...
            produces = {"audio/ogg"})
    public @ResponseBody
    byte[] audioOggSize(@PathVariable String size) throws IOException {
    ...
    public @ResponseBody
    byte[] documentDocSize(@PathVariable String size) throws IOException {
    ...
    @RequestMapping(
            ...
            produces = {"application/doc"})
    public @ResponseBody
    byte[] documentDocxSize(@PathVariable String size) throws IOException {
    ...
    public @ResponseBody
    byte[] documentXlsSize(@PathVariable String size) throws IOException {
    ...
    @RequestMapping(
            ...
            produces = {"application/xls"})
    public @ResponseBody
    byte[] documentXlsxSize(@PathVariable String size) throws IOException {
    ...
    public @ResponseBody
    byte[] documentPptSize(@PathVariable String size) throws IOException {
    ...
    public @ResponseBody
    byte[] documentPdfSize(@PathVariable String size) throws IOException {
    ...
    public @ResponseBody
    byte[] documentOdpSize(@PathVariable String size) throws IOException {
    ...
    public @ResponseBody
    byte[] documentOdsSize(@PathVariable String size) throws IOException {
    ...
    public @ResponseBody
    byte[] documentOdtSize(@PathVariable String size) throws IOException {
    ...
    public @ResponseBody
    byte[] documentRtfSize(@PathVariable String size) throws IOException {
    ...
    @RequestMapping(
            ...
            produces = {"text/csv"})
    public @ResponseBody
    byte[] otherCsvSize(@PathVariable String size) throws IOException {
    ...
    @RequestMapping(
            ...
            produces = {"text/html"})
    public @ResponseBody
    byte[] otherHtmlSize(@PathVariable String size) throws IOException {
    ...
    @RequestMapping(
            ...
            produces = {"text/plain"})
    public @ResponseBody
    byte[] otherTxtSize(@PathVariable String size) throws IOException {
    ...
    public @ResponseBody
    byte[] otherZipSize(@PathVariable String size) throws IOException {
